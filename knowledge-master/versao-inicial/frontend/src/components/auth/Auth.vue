<template>
    <div class="auth-content">
        <div class="auth-modal">
            ...
            <input v-model="user.password" placeholder="Senha" name="password" type="password">
    ...
    methods: {
        signin() {
            axios.post(`${baseApiUrl}/signin`, this.user)
                .then(res => {
                    this.$store.commit('setUser', res.data) // Seta o user no store a partir do método setUser
